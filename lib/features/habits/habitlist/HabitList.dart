...
class _HabitListState extends State<HabitList> {
  ...
  List<Habit>? get events => null;

  void _toggleCompletedHabitsCardVisibility() {
    setState(() {
      _isCompletedHabitsCardVisible = !_isCompletedHabitsCardVisible;
      _completedHabitsCardPosition = _isCompletedHabitsCardVisible
          ? 0
          : -300; // Set the height of the completed habits card
    });
  }
                  ...
                  AnimatedPositioned(
                    ...
                    child: GestureDetector(
                      onVerticalDragUpdate: (details) {
                        if (details.primaryDelta != null) {
                          setState(() {
                            ...
                            } else if (_completedHabitsCardPosition < -300) {
                      ...
                      child: CompletedHabitsCard(
                        ...
                        onCardTapped: _toggleCompletedHabitsCardVisibility,
